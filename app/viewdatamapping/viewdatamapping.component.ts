...
@Component({
  selector: 'app-viewdatamapping',
  templateUrl: './viewdatamapping.component.html',
  styleUrls: ['./viewdatamapping.component.scss'],
})
export class ViewdatamappingComponent implements OnInit {
